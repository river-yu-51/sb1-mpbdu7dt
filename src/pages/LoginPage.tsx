    ...
    <div className="py-20 bg-grima-50 min-h-screen">
      <div className="max-w-md mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-white rounded-lg shadow-lg p-8">
          ...
          {/* Demo Credentials */}
          <div className="mt-8 p-4 bg-grima-50 rounded-lg">
            <h3 className="text-sm font-semibold text-gray-900 mb-2">Demo Account</h3>
            <p className="text-sm text-gray-600 mb-2">Try the platform with these credentials:</p>
